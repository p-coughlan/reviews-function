...
//show random person
//uses the Math.random() method to generate a random number between 0 and 1. We then multiply that number by the length of the reviews array to get a random number between 0 and the last index of the array. We then use Math.floor() to round down to the nearest whole number.
